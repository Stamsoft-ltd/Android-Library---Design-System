...
@Composable
fun H4(text: String, color: Color = LocalDSTheme.current.colors.base0, textAlign: TextAlign? = null, @FontRes font: Int) {
    Text(
        text = text,
        fontSize = FontSizeTokens.font_size_250,
        fontWeight = LineWeightTokens.line_weight_250,
...
@Composable
fun H5(text: String, color: Color = LocalDSTheme.current.colors.base0, textAlign: TextAlign? = null, @FontRes font: Int) {
    Text(
        text = text,
        fontSize = FontSizeTokens.font_size_200,
        fontWeight = LineWeightTokens.line_weight_250,
...
@Composable
fun H6(text: String, color: Color = LocalDSTheme.current.colors.base0, textAlign: TextAlign? = null, @FontRes font: Int) {
    Text(
        text = text,
        fontSize = FontSizeTokens.font_size_200,
        fontWeight = LineWeightTokens.line_weight_250,
